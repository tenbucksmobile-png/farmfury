...
## Project Location
`C:\Users\Personel\FarmFury`

The Unity project lives inside a monorepo rooted at `C:\Users\Personel`.
To push only FarmFury to GitHub:
```
cd C:\Users\Personel
git subtree push --prefix=FarmFury farmfury main
```
